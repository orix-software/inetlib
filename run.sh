...
cl65 -ttelestrat --include-dir src/include tests/inetaton.c inet.lib -o 1000 --start-addr \$800
cl65 -ttelestrat --include-dir src/include tests/inetaton.c inet.lib -o 1256 --start-addr \$900
